...
# 30
({struct Cyc_String_pa_PrintArg_struct _tmp2=({struct Cyc_String_pa_PrintArg_struct _tmp8;_tmp8.tag=0U,_tmp8.f1=(struct _fat_ptr)((struct _fat_ptr)file);_tmp8;});struct Cyc_Int_pa_PrintArg_struct _tmp3=({struct Cyc_Int_pa_PrintArg_struct _tmp7;_tmp7.tag=1U,_tmp7.f1=line;_tmp7;});struct Cyc_String_pa_PrintArg_struct _tmp4=({struct Cyc_String_pa_PrintArg_struct _tmp6;_tmp6.tag=0U,_tmp6.f1=(struct _fat_ptr)((struct _fat_ptr)assertion);_tmp6;});void*_tmp0[3U];_tmp0[0]=& _tmp2,_tmp0[1]=& _tmp3,_tmp0[2]=& _tmp4;({struct Cyc___cycFILE*_tmpA=Cyc_stderr;struct _fat_ptr _tmp9=({const char*_tmp1="%s:%u: Assertion `%s' failed.\n";_tag_fat(_tmp1,sizeof(char),31U);});Cyc_fprintf(_tmpA,_tmp9,_tag_fat(_tmp0,sizeof(void*),3U));});});
# 32
